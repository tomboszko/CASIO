...
const timeZoneLists = document.getElementById("timeZoneList");

timeZoneLists.addEventListener("change", function () {
 
  const selectedTimeZone = timeZoneList.value;
  ...
  localTimeElement.textContent = `UTC Time: ${formattedDate}`;
});
